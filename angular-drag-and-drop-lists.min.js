...
try{c.dataTransfer.setData(t,p)}catch(e){var v=n(d,o.effectAllowed)
c.dataTransfer.effectAllowed=v[0],c.dataTransfer.setData(r,p)}}if(f.addClass("dndDragging"),i(function(){f.addClass("dndDraggingSource")},0),c._dndHandle&&c.dataTransfer.setDragImage){var D=c.srcElement||c.target,y=angular.element(D)[0]
c.dataTransfer.setDragImage(f[0],0,0)
var T=angular.element(f)[0],h=T.offsetWidth-y.offsetWidth/2,m=y.offsetHeight/2
c.dataTransfer.setDragImage(f[0],h,m)}if(e(s.dndDragstart)(l,{event:c}),s.dndCallback){var E=e(s.dndCallback)
...
if(!n||!g(a))return!0
e.preventDefault()
try{var d=JSON.parse(e.dataTransfer.getData(n))}catch(e){return p()}if((n==r||n==t)&&(a=d.type||void 0,d=d.item,!g(a)))return p()
var l=n==r,y=u(e,l)
if("none"==y)return p()
var T=D()
