...
c.dataTransfer.effectAllowed=v[0],c.dataTransfer.setData(t,p)}}if(f.addClass("dndDragging"),i(function(){f.addClass("dndDraggingSource")},0),c._dndHandle&&c.dataTransfer.setDragImage){var D=angular.element(c.srcElement)[0]
c.dataTransfer.setDragImage(f[0],0,0)
var y=angular.element(f)[0],T=y.offsetWidth-D.offsetWidth/2,h=D.offsetHeight/2
c.dataTransfer.setDragImage(f[0],T,h)}if(e(s.dndDragstart)(l,{event:c}),s.dndCallback){var m=e(s.dndCallback)
o.callback=function(e){return m(l,e||{})}}c.stopPropagation()}),f.on("dragend",function(n){n=n.originalEvent||n,l.$apply(function(){var a=o.dropEffect
